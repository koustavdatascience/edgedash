...
def inject_css() -> None:
    ...
    .hero-copy { position:relative; z-index:1; padding:38px 44px 42px; color:#fff; max-width:760px; } .eyebrow { color:#b8d2ff; text-transform:uppercase; letter-spacing:.08em; font:500 10px 'DM Mono',monospace; margin-bottom:14px; }
    h1 { font:400 clamp(42px,6.2vw,76px)/.93 'Newsreader',serif; letter-spacing:-.04em; margin:0 0 18px; max-width:680px; } .hero-sub { font-size:15px; line-height:1.45; max-width:440px; color:rgba(255,255,255,.82); margin:0 0 25px; }
