...
def inject_css() -> None:
    ...
    header[data-testid="stHeader"] { background:transparent; } [data-testid="stToolbar"] { display:none; }
    .ed-nav { height:70px; display:flex; align-items:center; justify-content:space-between; border-bottom:1px solid var(--line); margin-bottom:26px; }
    .brand { display:flex; align-items:center; gap:10px; font-weight:700; letter-spacing:-.03em; color:var(--ink); text-decoration:none; }
    ...
    .hero { position:relative; overflow:hidden; border-radius:20px; min-height:min(70vh,600px); display:flex; flex-direction:column; justify-content:flex-end; background:#cdd7dc; box-shadow:0 20px 60px rgba(16,24,40,.12); }
    .hero-img { position:absolute; inset:0; display:block; min-width:100%; min-height:100%; width:100%; height:100%; object-fit:cover; object-position:center; filter:saturate(.82) contrast(.96); } .hero:after { content:''; position:absolute; inset:0; background:linear-gradient(180deg,rgba(7,29,64,.04) 30%,rgba(7,24,52,.7) 100%); }
    ...
    .hero-copy { position:relative; z-index:1; padding:38px 44px 42px; color:#fff; max-width:760px; } .eyebrow { color:#b8d2ff; text-transform:uppercase; letter-spacing:.16em; font:500 10px 'DM Mono',monospace; margin-bottom:14px; }
    h1 { font:400 clamp(42px,6.2vw,76px)/.93 'Newsreader',serif; letter-spacing:-.055em; margin:0 0 18px; max-width:680px; } .hero-sub { font-size:15px; line-height:1.45; max-width:440px; color:rgba(255,255,255,.82); margin:0 0 25px; }
    ...
    @media (max-width:760px) { .block-container { padding:0 16px 48px; } .hero { min-height:560px; } .hero-copy { padding:28px 24px; } .step-grid,.feature-grid,.proof-grid,.proof-stats,.docs-grid,.dash-metrics { grid-template-columns:1fr; } .docs-hero { padding:28px 24px; } .flow { grid-template-columns:1fr; } .flow-step:not(:last-child):after { content:'↓'; right:auto; left:18px; top:auto; bottom:-10px; } .step-card:not(:last-child):after { width:1px; height:10px; right:auto; left:34px; top:auto; bottom:-10px; } .signal-strip { grid-template-columns:1fr 1fr; } .signal:nth-child(3) { border-left:0; border-top:1px solid var(--line); } .signal:nth-child(4) { border-top:1px solid var(--line); } .final-cta { display:block; padding:28px 24px; } .final-cta .cta { margin-top:20px; } .section { padding-top:58px; } .section-head { display:block; } .section-note { text-align:left; margin-top:12px; } .footer { display:block; } .footer .cta { margin-top:18px; } }
    /* Editorial landing replacement: image-first hero matching the approved page */
    .ed-nav { position:relative; z-index:3; margin:14px 0 -72px; padding:0 18px; height:58px; border:1px solid rgba(255,255,255,.28); border-radius:14px; background:rgba(255,255,255,.72); backdrop-filter:blur(16px); box-shadow:0 8px 28px rgba(16,24,40,.08); }
    .brand-mark { color:#fff; background:#171717; }
    .hero { margin:0 -32px; min-height:min(46vh,520px); border-radius:0; box-shadow:none; background:#cdd7dc; }
    ...
    @media (max-width:760px) { .ed-nav { margin:14px 0 -58px; } .hero { margin:0 -16px; min-height:280px; } .editorial-hero-copy { padding:34px 0 30px; } .editorial-hero-copy h1 { font-size:49px; } }
    </style>
