...
def inject_css() -> None:
    ...
    .nav-links { display:flex; gap:10px; margin-left:auto; margin-right:10px; color:#475467; font-size:12px; } .nav-links a { color:inherit; text-decoration:none; }
...
def render_nav() -> None:
    st.markdown(f'<nav class="ed-nav"><a class="brand" href="#top"><span class="brand-mark">→</span><span>edgedash</span></a><div class="nav-links"><a class="nav-install" href="{DASHBOARD_URL}">About the dashboard</a><a class="nav-install" href="?page=docs">Documentation</a><a class="nav-install" href="https://github.com/koustavdatascience/edgedash" target="_blank" rel="noreferrer">GitHub</a></div></nav>', unsafe_allow_html=True)
